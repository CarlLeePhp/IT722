...
namespace EZDIJKST
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            foreach(List<Vertex> vertices in cases)
            {
                FindShortestPath(vertices, startPoints.Dequeue() - 1, endPoints.Dequeue() - 1);
            }

            Console.ReadLine();
        } // Main
        static void FindShortestPath(List<Vertex> vertices, int startPoint, int endPoint)
        {
            ...
            {
                Console.WriteLine(vertices[endPoint].Key);
            }
